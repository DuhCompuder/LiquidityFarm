...
describe("TokenFarm", () => {
    ...
    beforeEach(async() => {
        ...
        tokenFarm = await TokenFarm.deploy(mockDai.address, testToken.address);
    })

    describe("Init", async() => {
        it("should initialize", async() => {
            expect(testToken).to.be.ok
    ...
    describe("WithdrawYield", async() => {
        beforeEach(async() => {
            await testToken.transferOwnership(tokenFarm.address)
        ...
        it("should mint correct token amount in total supply and user", async() => {
            ...
            res = await testToken.totalSupply()
            ...
            res = await testToken.balanceOf(alice.address)
